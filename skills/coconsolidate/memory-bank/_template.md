...
## Registry
{element-class rows added or updated — signature, canonical, master}

## Notes
{sites left alone + why, scope handed to coplan, follow-ups}

<!-- lens: logic | visual -->
<!-- cause: D1 copy-paste | D2 parallel reimpl | D3 forked-and-drifted | D4 loose spec | D5 bypassed master -->
<!-- tier: C0 tighten spec | C1 extract | C2 parameterize | C3 compose | C4 surgical adopt -->
<!-- status: open | building | done -->
