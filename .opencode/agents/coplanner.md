...
1. Read the project's configured `<workspaceRoot>/skills/coplan/SKILL.md` — that is your full operating guide. If it is not available, read `skills/coplan/SKILL.md` from this repository.
