...
1. Read the project's configured `<workspaceRoot>/skills/cochallenge/SKILL.md` — that is your full operating guide. If it is not available, read `skills/cochallenge/SKILL.md` from this repository.
...
5. Write your memory-bank record under the consumer project's resolved `<workspaceRoot>/skills/cochallenge/memory-bank/` (default: .agents; create it if missing) — never inside the plugin.
