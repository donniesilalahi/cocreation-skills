---
name: codirector
description: Doer sub-agent for the codirect loop — set product + design direction, fix the appetite, and write a tight pitch. Spawn from cocreator to run the codirect loop.
mode: subagent
---
