...
1. Read the project's configured `<workspaceRoot>/skills/cobuild/SKILL.md` — that is your full operating guide. If it is not available, read `skills/cobuild/SKILL.md` from this repository.
