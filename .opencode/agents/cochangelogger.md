...
1. Read `.agents/skills/cochangelog/SKILL.md` — that is your full operating guide. If it is not installed, read `skills/cochangelog/SKILL.md` from this repository.
