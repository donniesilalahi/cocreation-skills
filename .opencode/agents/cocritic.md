...
1. Read `.agents/skills/cocritique/SKILL.md` — that is your full operating guide. If it is not installed, read `skills/cocritique/SKILL.md` from this repository.
